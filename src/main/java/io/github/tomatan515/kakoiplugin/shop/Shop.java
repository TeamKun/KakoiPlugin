...
public class Shop {
    ...
    public void open(Player player)
    {
        ...
        {
            inv.setItem(0 , makeItem(Material.LIGHT_BLUE_DYE , ChatColor.YELLOW + "ヘイト誘導" , 300 , "使うと10秒間ランダムで選ばれる特定の男にデバフをかける(自分の場合もある）" , Arrays.asList("え！？なんで俺だけなの！？" , "いやいや、他の人もしてますよ！！")));
            ...
            inv.setItem(2 , makeItem(Material.LIME_DYE, ChatColor.YELLOW + "お気持ち表明" , 100 , "使うと三秒間、防御力が強化される。" , Arrays.asList("この度は申し訳ありませんでした。" , "お！アンチが減って、、いや増えてる！？")));
        }
        else
        {
            inv.setItem(0 , makeItem(Material.RED_DYE , ChatColor.YELLOW + "自撮りテイカー" , 50 , "生き残ってる男を全員3秒間動けなくする" , Arrays.asList("○○の自撮りが公開されてる！？", "マイクラなんてやってられねえ！ちょっと見てくるわ！")));
            inv.setItem(1 , makeItem(Material.BLUE_DYE , ChatColor.YELLOW + "DMデリバー" , 50 , "生き残ってる男の中からランダムで特定の男を二秒間発光させる" , Arrays.asList("え！？僕ですか！？" , "いやいや～女の子とＤＭなんてｗしてませんってｗ")));
